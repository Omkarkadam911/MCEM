...
public class WorkerDashboard extends JFrame {
    public WorkerDashboard() {
        ...
        JLabel title = new JLabel("Welcome, Worker!", SwingConstants.CENTER);
        ...
        addStyledButton(buttonPanel, "Mark Attendance", e -> new MarkAttendance());
        addStyledButton(buttonPanel, "Request Leave", e -> new RequestLeave());
        addStyledButton(buttonPanel, "View My Attendance", e -> new AttendanceLogViewer());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(WorkerDashboard::new);
    }
}